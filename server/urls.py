...
from amigo.views.amigo_views import AmigoDetailById,AmigoListLimitPaginator, RegistrarAmigo
...
from amigo.views.filtros import  ClientePorGenero, ClienteFiltro,Interes,Precio
