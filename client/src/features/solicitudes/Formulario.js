        ...
        <form className="application-form">
          ...
          <div className="form-box">
            <div className="form-item-alquilar">
              <label className="form-label required-label" htmlFor="fecha">
                Fecha
              </label>
              <input
              ...
              <p className="text-danger">
                {fechaValida(formData.fecha_inicio)}
              </p>
            </div>

            <div className="form-item-alquilar">
              <label htmlFor="hora" className="form-label required-label">
                Hora
              </label>
              <input
                className="form-control"
          ...
          <div className="form-box">
            <div id="duration-input" className="form-item-alquilar">
              <label htmlFor="duracion" className="form-label required-label">
                Duración (hrs)
              </label>
              <input
                className="form-control"
            ...
            <div id="direction-input" className="form-item-alquilar">
              <label htmlFor="direccion" className="form-label required-label">
                Dirección
              </label>
              <input
                className="form-control"
          ...
          <div className="form-item-alquilar w-100">
            <label htmlFor="descripcion" className="form-label required-label">
              Descripción
            </label>
            <textarea
              className="form-control"
          ...
          {showFeedback.status && (
            <p className="text-danger">{showFeedback.message}</p>
          )}

          <div className="form-bottom">
            <p id="texto-precio">Total: {precio * formData.duracion} Bs</p>
            <button
              className={`btn btn-azul ${disableBtn && "disabled"}`}
              type="button"
